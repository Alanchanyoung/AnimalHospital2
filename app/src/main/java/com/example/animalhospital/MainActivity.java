        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               if(!str_userid.equals("5")){
                   ...
                   return;
               }else if(str_userid.equals("30407") && str_passwd.equals("01012345678")){
                   Toast.makeText(MainActivity.this, "배찬영님 환영합니다", Toast.LENGTH_SHORT).show();
                   //다음화면으로 이동
                   return;
               }else{
                   Toast.makeText(MainActivity.this, "신원 불명", Toast.LENGTH_SHORT).show();
                   return;
               }
            }
        });
